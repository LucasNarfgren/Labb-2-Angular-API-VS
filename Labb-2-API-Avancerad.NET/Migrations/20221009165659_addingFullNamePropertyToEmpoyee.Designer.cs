...
namespace Labb_2_API_Avancerad.NET.Migrations
{
    ...
    [Migration("20221009165659_addingFullNamePropertyToEmpoyee")]
    partial class addingFullNamePropertyToEmpoyee
    {
            ...
            modelBuilder.Entity("Labb_2_API_Avancerad.NET.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EmployeeId = new Guid("02acb6a7-dcaa-48e2-aa11-d9abed8e28e1"),
                        ...
                        new
                        {
                            EmployeeId = new Guid("9315a085-ccec-4ff5-9443-b8bc0adfbb30"),
